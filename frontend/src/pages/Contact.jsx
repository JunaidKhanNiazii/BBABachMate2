    ...
    <div className="max-w-7xl mx-auto py-32 px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        <div className="lg:col-span-2">
          <div className="bg-neutral-900/50 p-8 md:p-12 rounded-2xl border border-white/5">
            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <input
                type="text"
                required
                className="px-6 py-4 bg-black border border-white/5 rounded-xl text-xs font-bold outline-none focus:border-blue-500 transition-all text-white placeholder:text-gray-600"
              ...
              />
              <select
                className="md:col-span-2 px-6 py-4 bg-black border border-white/5 rounded-xl text-xs font-bold outline-none focus:border-blue-500 transition-all text-white"
              ...
              <textarea
                required
                className="md:col-span-2 px-6 py-4 bg-black border border-white/5 rounded-xl text-xs font-bold h-40 outline-none focus:border-blue-500 transition-all text-white placeholder:text-gray-600"
        ...
        <div className="space-y-6">
          <div className="bg-neutral-900 border border-white/5 p-10 rounded-2xl">
            <h3 className="text-lg font-black mb-4 uppercase tracking-tight">DIRECT LINE</h3>
            <p className="text-gray-500 font-bold uppercase tracking-widest text-[10px] mb-6 leading-relaxed">
              Operating Hours:<br />
              <span className="text-white">09:00 - 18:00 UTC</span>
            </p>
            <a href="mailto:contact@aicon.net" className="text-blue-500 font-black uppercase tracking-widest text-[11px]">contact@aicon.net</a>
          </div>

          <div className="bg-neutral-900 border border-white/5 p-10 rounded-2xl">
            <h3 className="text-lg font-black mb-4 uppercase tracking-tight">LOCATION</h3>
