      ...
      <div className="mb-40">
        <div className="flex flex-col lg:flex-row items-center gap-12 mb-16">
          <div className="lg:w-1/2">
            <h2 className="text-3xl font-black uppercase mb-4 tracking-tight">INDUSTRY <span className="text-blue-600">SERVICES</span></h2>
            <p className="text-gray-500 text-sm font-medium leading-relaxed uppercase tracking-widest border-l-2 border-blue-600 pl-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {industryServices.map((service, idx) => (
            <div key={idx} className="bg-neutral-900/50 p-8 rounded-xl border border-white/5 hover:border-blue-500/20 transition-all">
              <h3 className="text-lg font-black text-white mb-4 uppercase tracking-tight">{service.title}</h3>
              <p className="text-gray-500 text-xs font-bold uppercase tracking-widest leading-relaxed opacity-80">{service.description}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="mb-20">
        <div className="flex flex-col lg:flex-row-reverse items-center gap-12 mb-16">
          <div className="lg:w-1/2 text-right lg:text-right">
            <h2 className="text-3xl font-black uppercase mb-4 tracking-tight text-white">UNIVERSITY <span className="text-white opacity-50">SERVICES</span></h2>
            <p className="text-gray-500 text-sm font-medium leading-relaxed uppercase tracking-widest border-r-2 border-white/20 pr-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {universityServices.map((service, idx) => (
            <div key={idx} className="bg-neutral-900 p-8 rounded-xl border border-white/5 hover:border-white/20 transition-all">
              <h3 className="text-lg font-black text-white mb-4 uppercase tracking-tight">{service.title}</h3>
              <p className="text-gray-500 text-xs font-bold uppercase tracking-widest leading-relaxed opacity-80">{service.description}</p>
            </div>
          ))}
